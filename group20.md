...
### 李鑫 2024303120020
1、在当今数字化时代，数据已成为推动各行各业发展的核心资源。这学期我有幸修读了《数据驱动分析》这门课程，它不仅拓宽了我的知识视野，更让我深刻体会到数据在决策过程中的关键作用，为我未来的职业发展奠定了坚实基础，在本堂课程的学习中，我学习了python、vscode、git等多个软件的使用，掌握了一定的软件使用方法，在课程学习中虽然存在较多的困难，但是帮助我学习到更多的计算机知识，拓宽视野。
2、在课程的学习中我认识到可以通过计算机软件和代码进行数据收集、数据分析，对我今后课题研究有着很深的影响。
